...
function dazi()
{
    let str="......她喜欢吃辣，喜欢卤味，最喜欢螺蛳粉,她的麻辣烫和烤鱼里总要放一块面，她喜欢在风景好的地方相遇。<她喜欢奶茶，有时候是奶绿，有时候是奶盖，有时候是霓裳茶舞，她要的只是三分糖，可以加的是珍珠。<她喜欢水果捞,爱加酸奶和芋圆，不喜欢水果捞里的爆珠，可以放烧仙草但不会加椰果。<......我的记性很差，所以每次发消息都会下意识地先点到你的聊天框，然后再想起来要做什么。<<你占领每个-永恒的片刻<无垠的宇宙-浩瀚的选择<万千星河，你是最亮那颗<你知道吗，我可以为你写一万行代码，就像.....我可以说一万遍，一万遍喜欢你<见到你-便是三行情诗<";//利用<作为换行符 -作为空格
    let strp="";
    let i=0;
    function print1()
    {
...
let a=[
    {name:"A",yin:8, str:"<br><br>我喜欢你，不分日夜，我喜欢你，永永远远。<br><br>爱你不是两三天,每天都会喜欢你很多遍。<br><br>以及其他的键<br><br>那些都是关于你的声音。以及，找一下声音里关于你的线索。"},
    ...
    if((key<='z'&&key>='a')||(key<='Z'&&key>='A'))
    {
        ...
        if(s.indexOf("XIAOLUXIAOLUWXHN")!=-1&&records==0)
        {
            ...
            setTimeout(function()
            {
                ...
                x.setAttribute("src", `./video/snjxh2.mp3`);
                x.setAttribute("autoplay","autoplay");
            },1000);
            setTimeout(dazi,3000);
        }
        else
        {
        setTimeout(function()
